...
<html>
    ...
    <!--HEADER-->
    <div class="header">
    <h2 class="titolo_news">REGISTRATI</h2>
        <div class="line"></div>
    </div>
    <!--FINE HEADER-->

    <!--CONTENT-->
    <div class="content"><!--Metto un riquadro per registrarsi-->
        <div class="centro">
            <div class="rettangolo_accedi">
                ...
                <form action="#" method="post" class="dati_accesso">
                    ...
                    <input type="text"> <br>
                    <label for="pass2">Conferma password</label> <br>
                    <input type="text"> <br>
                    <label for="date">Anno di nascita</label> <br>
                    <input type="date"> <br>
                    ...
                    <input type="submit" name="tasto" value="Entra" class="tasto_registrati">
                </form>
            </div>    
        </div>
    </div>
